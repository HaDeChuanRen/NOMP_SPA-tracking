...
load('true_history.mat');


[state_dim, sample_time, ~] = size(history_all);
...
Delta_thr = 1000;
[OSPA_dist, label_vec] = OSPA_cal(ground_all, history_copy, Delta_thr);
...
for t_time = 1 : sample_time
    ...
    for k_idx = 1 : K_est
        ...
        phandle_hat = plot(history_copy(1, 1 : t_time, k_idx), ...
            history_copy(3, 1 : t_time, k_idx), color_vec(c_idx, :), 'LineWidth', Lw, 'Marker', 's', 'MarkerSize', Msz);
    end
